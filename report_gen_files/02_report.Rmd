...
```{r phylo-tree", echo=FALSE, message=FALSE, warning=FALSE, fig.pos='h', out.width="100%", fig.cap="\\newline{}"}
  ...
  library(knitr)
  library(gtools)
  tree_filenames <- list.files("../graphlan/phylo_trees",pattern="*_image_graph.png",full.names=T)
...
#   tree_filenames <- list.files("./graphlan/phylo_trees",pattern="*_image_pdf_g.png", full.names=T)
#   tree_filenames <- mixedsort(tree_filenames)
# 
#   include_graphics(tree_filenames)
#   
