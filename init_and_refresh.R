...
if(!require(dbplyr)) renv::install("dbplyr@2.1.1")
if(!require(lubridate)) renv::install("lubridate@1.7.10")
if(!require(reprex )) renv::install("reprex@2.0.0")
if(!require(tidyverse)) renv::install("tidyverse@2.1.1")
#renv::restore()
#renv::snapshot()
q()
