...
if(!require(ggdendro)){install.packages("ggendro",repos="https://cloud.r-project.org/", type="source", dep=TRUE)}
...
#if(!require(pegas)){install.packages("pegas",dep=TRUE,repos="https://cloud.r-project.org/", type="source")}
