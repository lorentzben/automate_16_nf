...
bray_pcoa <- qiime2R::read_qza("./qiime/core-metrics-results/bray_curtis_pcoa_results.qza")
shannon<-qiime2R::read_qza("./qiime/core-metrics-results/shannon_vector.qza")
...
metadata<-read_q2metadata(metadata_file)
jaccard <- qiime2R::read_qza("./qiime/core-metrics-results/jaccard_pcoa_results.qza")
shannon<-qiime2R::read_qza("./qiime/core-metrics-results/shannon_vector.qza")
shannon <- shannon$data %>% rownames_to_column("SampleID")
...
metadata<-read_q2metadata(metadata_file)
metadata[[ioi]] <- reorder(metadata[[ioi]])
jaccard <- qiime2R::read_qza("./qiime/core-metrics-results/unweighted_unifrac_pcoa_results.qza")
shannon<-qiime2R::read_qza("./qiime/core-metrics-results/shannon_vector.qza")
shannon <- shannon$data %>% rownames_to_column("SampleID")
...
metadata<-read_q2metadata(metadata_file)
metadata[[ioi]] <- reorder(metadata[[ioi]])
jaccard <- qiime2R::read_qza("./qiime/core-metrics-results/weighted_unifrac_pcoa_results.qza")
shannon<-qiime2R::read_qza("./qiime/core-metrics-results/shannon_vector.qza")
shannon <- shannon$data %>% rownames_to_column("SampleID")
...
metadata<-read_q2metadata(metadata_file)
metadata[[ioi]] <- reorder(metadata[[ioi]])
w_unifrac_dist <- qiime2R::read_qza("./qiime/core-metrics-results/weighted_unifrac_distance_matrix.qza")
u_unifrac_dist <- qiime2R::read_qza("./qiime/core-metrics-results/unweighted_unifrac_distance_matrix.qza")
...
jaccard <- qiime2R::read_qza("./qiime/core-metrics-results/jaccard_distance_matrix.qza")
# Jaccard 
