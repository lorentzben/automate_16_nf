...
table-dada2 <- "./qiime/table-dada2.qza"
rooted-tree <- "./qiime/rooted-tree.qza"
taxonomy-file <- "./qiime/taxonomy.qza"
metadata-file <- "./metadata.tsv"


#Create phyloseq object from qiime objects
cycle_1 <- qza_to_phyloseq(table-dada2,rooted-tree,taxonomy-file,metadata-file)
...
library(qiime2R)
metadata<-read_q2metadata(metadata-file)
