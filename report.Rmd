...
if(!require(remotes)){install.packages("remotes", repos="http://cran.us.r-project.org", type="source")}
if(!require(ggplot2)) {remotes::install_github("tidyverse/ggplot2@v3.3.2")}
if(!require(tidyverse)) {install.packages("tidyverse", repos="http://cran.us.r-project.org", type="source")}
if(!require(usethis)) {install.packages("usethis", repos="http://cran.us.r-project.org", type="source")}
if(!require(tibble)) {install.packages("tibble", repos="http://cran.us.r-project.org", type="source")}
if(!require(openssl)) {install.packages("openssl", repos="http://cran.us.r-project.org", type="source")}
if(!require(knitr)) {install.packages("knitr", repos="http://cran.us.r-project.org", type="source")}



if (!require("devtools", quietly = TRUE)){install.packages("devtools", repos="http://cran.us.r-project.org", type="source")}
...
if(!require(ggdendro)){install.packages("ggendro",repos="https://cloud.r-project.org/", type="source", deps=TRUE)}
if(!require(vegan)){install.packages("vegan",repos="http://cran.us.r-project.org", type="source")}
#if(!require(ape)){install.packages("ape",dep=TRUE,repos="http://cran.us.r-project.org", type="source")}
#if(!require(adegenet)){install.packages("adegenet",dep=FALSE,repos="http://cran.us.r-project.org", type="source")}
#if(!require(ade4)){install.packages("ade4",dep=TRUE,repos="http://cran.us.r-project.org", type="source")}
#if(!require(pegas)){install.packages("pegas",dep=TRUE,repos="http://cran.us.r-project.org", type="source")}

if(!require(ggvegan)){remotes::install_github("gavinsimpson/ggvegan")}
if(!require(ggpubr)){install.packages("ggpubr",repos="http://cran.us.r-project.org", type="source")}
if(!require(dplyr)){install.packages("dplyr",repos="http://cran.us.r-project.org", type="source")}
...
if(getOutputFormat() == 'html_document') {
  tree_filenames <- list.files(pattern="graphlan/phylo_trees/image_.*_graph.png")
...
if(getOutputFormat() =='pdf_document'){
  print("see end of report")
  tree_filenames <- list.files(pattern="graphlan/phylo_trees/image_.*_pdf_g.png")
  tree_filenames <- mixedsort(tree_filenames)
...
if(getOutputFormat() == 'html_document') {
  lefse_res_filenames <- list.files(pattern="lefse/result/*_res.png")
...
if(getOutputFormat() =='pdf_document'){
  print("see end of report")
  lefse_res_filenames <- list.files(pattern="lefse/result/*_pdf_r.png")
...
if(getOutputFormat() == 'html_document') {
  ...
  lefse_clado_filenames <- list.files(pattern="result/*_cladogram.png")
...
if(getOutputFormat() =='pdf_document'){
  print("see end of report")
  lefse_clado_filenames <- list.files(pattern="result/*_pdf_qual_clad.png")
