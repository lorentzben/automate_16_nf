...
BiocManager::repositories(version="3.13")
...
if(!require(phyloseq)) {renv::install("bioc::phyloseq")}
if(!require(biomformat)) {renv::install("bioc::biomformat",version="3.13")}
#renv::restore()
```
...
dunn_table <- read.table("./qiime/obs/kruskal-wallis-pairwise-treatment.csv",header=TRUE, sep=",") 
dunn_table<- add_significance(dunn_table, p.col="q.value",output.col = "p.adj.signif",symbols =c("****", "***", "**", "$*$", "ns"))
colnames(dunn_table) <- c("group1","group2","H","p.value","q.value","p.adj.signif")
kable(dunn_table) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
...
dunn_table <- read.table('./qiime/shannon/kruskal-wallis-pairwise-treatment.csv',header=TRUE, sep=",")
dunn_table<- add_significance(dunn_table, p.col="q.value",output.col = "p.adj.signif",symbols =c("****", "***", "**", "$*$", "ns"))
colnames(dunn_table) <- c("group1","group2","H","p.value","q.value","p.adj.signif")
kable(dunn_table) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
...
dunn_table <- read.table('./qiime/simpson/kruskal-wallis-pairwise-treatment.csv',header=TRUE, sep=",")
dunn_table<- add_significance(dunn_table, p.col="q.value",output.col = "p.adj.signif",symbols =c("****", "***", "**", "$*$", "ns"))
colnames(dunn_table) <- c("group1","group2","H","p.value","q.value","p.adj.signif")
kable(dunn_table) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
...
dunn_table <- read.table('./qiime/chao1/kruskal-wallis-pairwise-treatment.csv',header=TRUE, sep=",")
dunn_table<- add_significance(dunn_table, p.col="q.value",output.col = "p.adj.signif",symbols =c("****", "***", "**", "$*$", "ns"))
colnames(dunn_table) <- c("group1","group2","H","p.value","q.value","p.adj.signif")
kable(dunn_table) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
...
dunn_table <- read.table('./qiime/ace/kruskal-wallis-pairwise-treatment.csv',header=TRUE, sep=",")
dunn_table<- add_significance(dunn_table, p.col="q.value",output.col = "p.adj.signif",symbols =c("****", "***", "**", "$*$", "ns"))
colnames(dunn_table) <- c("group1","group2","H","p.value","q.value","p.adj.signif")
kable(dunn_table) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
...
dunn_table <- read.table('./qiime/faith_pd/kruskal-wallis-pairwise-treatment.csv',header=TRUE, sep=",")
dunn_table<- add_significance(dunn_table, p.col="q.value",output.col = "p.adj.signif",symbols =c("****", "***", "**", "$*$", "ns"))
colnames(dunn_table) <- c("group1","group2","H","p.value","q.value","p.adj.signif")
kable(dunn_table) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
