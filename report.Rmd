...
#renv::install("bioc::rhdf5",version="3.12")
renv::install("bioc::Biostrings",version="3.12")
renv::install("bioc::Biobase",version="3.12")
renv::install("bioc::phyloseq",version="3.12")
renv::install("bioc::biomformat",version="3.12")
renv::restore()
```
...
renv::install("tidyverse/ggplot2@v3.3.2")
renv::install("tidyverse@1.3.1")
if(!require(stringi)) {renv::install("stringi")}
renv::install("vctrs@0.3.7")
renv::install("openssl")

if (!require("devtools", quietly = TRUE)){renv::install("devtools")}
renv::install("jbisanz/qiime2R@d1ad96657ada993cf6c2841b29113a4f635c6b56") # current version is 0.99.20
#BiocManager::install("phyloseq", version="3.12")
...
#if(!require(ape)){renv::install("ape@5.5")}
