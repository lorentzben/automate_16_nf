...
ioi <- read.csv(paste0(getwd(),"/item_of_interest.csv"))
...
if(getOutputFormat() == 'html_document') {
  tree_filenames <- list.files(pattern="phylo_trees/image_.*_graph.png")
...
if(getOutputFormat() =='pdf_document'){
  print("see end of report")
  tree_filenames <- list.files(pattern="phylo_trees/image_.*_pdf_g.png")
  tree_filenames <- mixedsort(tree_filenames)
...
if(getOutputFormat() == 'html_document') {
  lefse_res_filenames <- list.files(pattern="result/*_res.png")
...
if(getOutputFormat() =='pdf_document'){
  print("see end of report")
  lefse_res_filenames <- list.files(pattern="result/*_pdf_r.png")
