...
dunn_table <- read.table('./qiime/shannon/kruskal-wallis-pairwise-treatment.csv')
dunn_table<- add_significance(dunn_table, p.col="q.value",output.col = "p.adj.signif",symbols =c("****", "***", "**", "$*$", "ns"))
colnames(dunn_table) <- c("group1","group2","H","p.value","q.value","p.adj.signif")
kable(dunn_table) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
...
dunn_table <- read.table('./qiime/simpson/kruskal-wallis-pairwise-treatment.csv')
dunn_table<- add_significance(dunn_table, p.col="q.value",output.col = "p.adj.signif",symbols =c("****", "***", "**", "$*$", "ns"))
colnames(dunn_table) <- c("group1","group2","H","p.value","q.value","p.adj.signif")
kable(dunn_table) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
...
dunn_table <- read.table('./qiime/chao1/kruskal-wallis-pairwise-treatment.csv')
dunn_table<- add_significance(dunn_table, p.col="q.value",output.col = "p.adj.signif",symbols =c("****", "***", "**", "$*$", "ns"))
colnames(dunn_table) <- c("group1","group2","H","p.value","q.value","p.adj.signif")
kable(dunn_table) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
...
dunn_table <- read.table('./qiime/ace/kruskal-wallis-pairwise-treatment.csv')
...
dunn_table <- read.table('./qiime/faith_pd/kruskal-wallis-pairwise-treatment.csv')
dunn_table<- add_significance(dunn_table, p.col="p.adj",output.col = "p.adj.signif",symbols =c("****", "***", "**", "$*$", "ns"))
colnames(dunn_table) <- c("group1","group2","H","p.value","q.value","p.adj.signif")
kable(dunn_table) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
