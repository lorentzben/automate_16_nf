...
counts_w_species <- merge(data.frame(taxa_sums(cycle_1)), tax_table(cycle_1)[,7])
counts_w_species$Species <- counts_w_species$Species %>% replace_na("Bacteria")
aggregate(. ~ Species, data=counts_w_species, FUN=sum)
```